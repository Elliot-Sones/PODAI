...
import { Episode, PodcastWithEpisodes, isReady, episodeState } from 'podverse-utils';
      ...
      <div className="flex size-full flex-row gap-4">
        ...
        <div className="line-clamp-3 flex w-4/5 flex-col gap-2 truncate text-wrap">
          ...
          <div className="flex items-center gap-2">
            ...
            {!isReady(episode) && (
              <ProcessEpisodeButton episodeId={episode.id} currentStatus={episodeState(episode)} />
            )}
          </div>
        </div>
      </div>
