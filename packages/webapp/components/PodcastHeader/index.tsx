...
import { ProcessAllButton } from '@/components/ProcessButton';
  ...
  return (
    <div className="flex w-full flex-col gap-4 font-mono">
      ...
      <div className="flex w-full flex-col sm:flex-row gap-4 items-start sm:items-center">
        ...
        {podcast.Episodes.length > podcast.Episodes.filter(isReady).length && (
          <ProcessAllButton podcastId={podcast.id} />
        )}
